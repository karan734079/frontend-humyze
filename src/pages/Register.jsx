        ...
        <div className="flex-grow flex items-center justify-center p-6 mt-20 z-10">
            ...
            >
                <div className="glass-card rounded-3xl p-8 relative overflow-hidden">
                    {/* Inner glows */}
                    <div className="absolute top-0 right-0 w-full h-1 bg-gradient-to-l from-transparent via-pink-500 to-transparent opacity-50"></div>
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-8">
                            <h1 className="text-3xl font-bold mb-2 pt-2">Create Account</h1>
                        ...
                        <form onSubmit={handleRegister} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full mt-2 py-3 rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-medium flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(236,72,153,0.3)] hover:shadow-[0_0_25px_rgba(236,72,153,0.5)] transition-all transform hover:-translate-y-1"
                            >
